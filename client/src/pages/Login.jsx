...
export default function Login() {
  ...
  // Auto-fill if redirected from Register
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center px-4">
      <div className={`border rounded-2xl p-8 w-full max-w-md shadow-xl ${cardBg}`}>
        ...
        {/* Header */}
        <div className="mb-6">
          <h1 className={`text-2xl font-bold mb-1 ${headingColor}`}>Welcome back</h1>
          <p className={`text-sm ${subColor}`}>Sign in to your account</p>
        </div>

        {/* Demo credentials hint */}
        <div className={`rounded-lg px-4 py-3 mb-5 text-xs border
          ...
          <p>User: &nbsp;<span className="font-mono">user@demo.com</span> / <span className="font-mono">user1234</span></p>
        </div>
